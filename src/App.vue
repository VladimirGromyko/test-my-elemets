...
<!--      скрывать выпадающие списки при отображении изображения (отображение: блок или видимость: видимый) и показывать их-->
<!--      при скрытом изображении (отображение: нет или видимость: скрыто)-->
<!--    </div>-->
